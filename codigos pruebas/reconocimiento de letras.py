# creando funciones o formas para optimizar la velocidad de ejecucion
...
# def CoordenadasMediapipe(landmarks):
#                         x = []
#                         y = []
#                         for i in range(0,68):
...
with mp_hands.Hands(
    ...
    # Accediendo a los puntos de referencia, de acuerdo a su nombre
                for hand_landmarks in results.multi_hand_landmarks:
                    ...
                    # obtener coordenadas del pinky_tip en x y y
                    x_pinky_tip = hand_landmarks.hand_landmarks[33][0]
                    y_pinky_tip = hand_landmarks.hand_landmarks[33][1]
                    # obtener coordenadas del index_tip en x y y
                    x_index_tip = hand_landmarks.hand_landmarks[30][0]
                    y_index_tip = hand_landmarks.hand_landmarks[30][1]
                    # obtener coordenadas del middle_tip en x y y
                    x_middle_tip = hand_landmarks.hand_landmarks[27][0]
                    y_middle_tip = hand_landmarks.hand_landmarks[27][1]
                    # obtener coordenadas del ring_tip en x y y
                    x_ring_tip = hand_landmarks.hand_landmarks[24][0]
                    y_ring_tip = hand_landmarks.hand_landmarks[24][1]
                    # obtener coordenadas del thumb_tip en x y y
                    x_thumb_tip = hand_landmarks.hand_landmarks[21][0]
                    y_thumb_tip = hand_landmarks.hand_landmarks[21][1]


                    # x,y = CoordenadasMediapipe(hand_landmarks.hand_landmarks)
                    # print(x,y)
                    # print(len(x))
                    # print(len(y))
                    # print(x[0],y[0])
