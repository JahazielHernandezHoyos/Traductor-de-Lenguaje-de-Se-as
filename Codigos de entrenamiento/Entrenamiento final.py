...
izquierda_train = np.load('/content/izquierda.npy')
izquierda_val =   np.load('/content/izquierda_val.npy')
derecha_train =   np.load('/content/derecha.npy')
derecha_val =     np.load('/content/derecha_val.npy')
